		...
		<footer className="footer-section">
			<div className="container relative">
				...
				<div className="sofa-img">
					<img src="images/sofa.jpeg" alt="Image" className="img-fluid"/>
				</div>
				...
				<div className="row g-5 mb-5">
					<div className="col-lg-4">
						<div className="mb-4 footer-logo-wrap"><Link to="#" className="footer-logo">BestFit Shoes<span>.</span></Link></div>
					...
					<div className="col-lg-8">
						<div className="row links-wrap">
							...
							<div className="col-6 col-sm-6 col-md-3">
								<ul className="list-unstyled">
									<li><Link to="#">Nordic Nike</Link></li>
									<li><Link to="#">Kruzo Adidas</Link></li>
									<li><Link to="#">Ergonomic Nike</Link></li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div className="border-top copyright">
					<div className="row pt-4">
						<div className="col-lg-6">
							<p className="mb-2 text-center text-lg-start">Copyright &copy;<script>document.write(new Date().getFullYear());</script>. All Rights Reserved. &mdash; Designed with love by <Link to="https://untree.co">Untree.co</Link> Distributed By <Link tof="https://themewagon.com">ThemeWagon</Link>  
            </p>
						</div>
